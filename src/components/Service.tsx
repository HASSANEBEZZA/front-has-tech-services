      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
          ...
          <div className="service-card p-4 bg-white shadow-lg rounded-lg">
            <Link to="/repair-info">
              <img src="https://i.imgur.com/DC7YOtA.png" alt="Illustration de dépannage informatique" className="w-full h-64 object-contain mb-2" />
            </Link>
          ...
          <div className="service-card p-4 bg-white shadow-lg rounded-lg">
            <Link to="/network-setup">
              <img src="https://i.imgur.com/vGJInfN.png" alt="Illustration de configuration réseau" className="w-full h-64 object-contain mb-2" />
            </Link>
            <p className="text-sm text-gray-500 text-center mb-4">
